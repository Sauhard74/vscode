...
// import { MockFilesystem } from '../common/promptSyntax/testUtils/mockFilesystem.js';
...
// 		const fileSystemProvider = disposables.add(new DiskFileSystemProvider(logService));
...
// 				const rootFolderUri = extUri.resolvePath(URI.file('/'), rootFolderName);

// 				console.log(`[test] rootFolderUri: '${rootFolderUri.path}' | '${rootFolderUri.fsPath}'`);

// 				const rootFileName = 'file2.prompt.md';
// 				const rootFileUri = extUri.resolvePath(rootFolderUri, rootFileName);

// 				await (instaService.createInstance(MockFilesystem,
// 					// the file structure to be created on the disk for the test
// 					[
// 						{
// 							name: rootFolderUri.path,
// 							children: [
// 								{
...
// 												`\t- some seemingly random #file:${rootFolderUri.fsPath}/folder1/some-other-folder/yetAnotherFolder🤭/another-file.prompt.md contents`,
// 												' some more\t content',
// 											],
// 										},
// 										{
...
// 																'---',
// 																`[](${rootFolderUri.fsPath}/folder1/some-other-folder)`,
